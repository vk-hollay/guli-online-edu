      ...
      <div>
        <article class="c-v-pic-wrap" style="height: 357px;">
          <section class="p-h-video-box" id="videoPlay">
            <img :src="courseWebVo.cover" :alt="courseWebVo.title" class="dis c-v-pic" height="375px" width="100%">
          </section>
        </article>
        <aside class="c-attr-wrap" style="height: 375px;">
        ...
        <aside class="thr-attr-box" style="height: 375px;">
                            ...
                            <ol class="lh-menu-ol" style="display: block;">
                              <li class="lh-menu-second ml30" v-for="video in chapter.children" :key="video.id">
                                <a :href="'/player/'+video.videoSourceId" target="_blank" v-if="isbuy || Number(courseWebVo.price)===0">
                                  <span class="fr">
                                    <i class="free-icon vam mr10" v-if="isbuy || Number(courseWebVo.price)===0">免费试听</i>
                                  </span>
                                  <em class="lh-menu-i-2 icon16 mr5">&nbsp;</em>{{video.title}}
                                </a>
                                <a href="#" v-else disabled>
                                  <em class="lh-menu-i-2 icon16 mr5">&nbsp;</em>{{video.title}}
                                </a>
                              </li>
                            </ol>
