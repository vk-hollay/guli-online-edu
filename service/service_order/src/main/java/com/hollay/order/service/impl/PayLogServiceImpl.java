...
import com.hollay.order.mapper.PayLogMapper;
import com.hollay.order.service.OrderService;
import com.hollay.order.service.PayLogService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.hollay.order.utils.HttpClient;
...
public class PayLogServiceImpl extends ServiceImpl<PayLogMapper, PayLog> implements PayLogService {
    ...
    //生成微信支付二维码接口
    @Override
    public Map createPaymentQRcode(String orderNo) {
        try {
            //1 根据订单号查询订单信息
